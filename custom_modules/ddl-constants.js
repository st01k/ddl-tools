module.exports = {
  ...
  KEYWORDS: {
    ...
    NC: [
      ...
      {DELSLAVE: 'Deletes a slave from an MCO', type: 'auxiliary'},
      {DELCARD: 'Deletes the CARD Access feature', type: 'auxiliary'},
      {DELETE: 'Allows the deletion of an object', type: 'auxiliary'},
      {DELTZ: 'Deletes the TIMEZONE Access feature', type: 'auxiliary'},
      ...
      {SLAVE: 'Slave for the MC', type: 'auxiliary'},
